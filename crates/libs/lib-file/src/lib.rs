    ...
    mod tests {
        ...
        fn lib_file_node_from_small_chunk() {
            ...
            assert_eq!(
                node.hash,
                [
                    96, 159, 110, 54, 210, 64, 85, 133, 24, 141, 92, 253, 118, 31, 64, 124, 124,
                    196, 106, 125, 63, 49, 76, 136, 39, 4, 105, 221, 227, 21, 252, 209
                ]
            )
        }
        ...
        fn lib_file_node_from_big_chunk() {
            ...
            assert_eq!(
                node.hash,
                [
                    34, 51, 8, 184, 150, 210, 92, 191, 251, 19, 222, 157, 179, 159, 210, 155, 130,
                    30, 98, 251, 142, 55, 111, 159, 195, 146, 118, 194, 231, 240, 11, 170
                ]
            );
        }
